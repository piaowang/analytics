...
import { WXJTYJCHANNELENUM, SENDCHANNELENUM, JPUSH_TARGET } from 'common/marketBrain/constants'
...
export default class CopyWriting extends Component {
  ...
  copyWriting() {
    ...
    if (SENDCHANNELENUM[feature][touch_up_way][send_channel] === WXJTYJCHANNELENUM['jPush']) {
