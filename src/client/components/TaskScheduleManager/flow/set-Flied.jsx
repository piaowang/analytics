...
class SetFliedComponent extends React.Component{
  ...
  getData = async () => {
    ...
    const url = `/app/task-schedule/manager?ajax=fetchProjectProps&project=${taskId}&refProjectId=${projectId}`
  ...
  submit = async () => {
    ...
    const url = `/app/task-schedule/manager?ajax=setProjectProps&project=${taskId}&param=${JSON.stringify(params)}&refProjectId=${projectId}`
    const result = await Fetch.post(url)
