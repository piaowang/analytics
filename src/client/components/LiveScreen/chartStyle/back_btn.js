...
export default function getBackBtn(styleConfig, updateFn) {
      ...
      items: [
        ...
        _.get(styleConfig, 'iconType', 'antd') === 'antd' ? (
          new StyleItem({
            ...
            name: 'iconSrc',
            type: 'input',
            value: _.get(styleConfig, 'iconSrc', 'poweroff'),
            onChange(ev){
              let {value} = ev.target
    ...
    new StyleItem({
      ...
      items: [
        new StyleItem({
          ...
          name: 'linkOverwrite',
          type: 'input',
          value: _.get(styleConfig, 'linkOverwrite', ''),
          onChange(ev){
            let {value} = ev.target
            updateFn('linkOverwrite', () => value)
          }
        })
      ]
    })
