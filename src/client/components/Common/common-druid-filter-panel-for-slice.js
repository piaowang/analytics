...
class CommonDruidFilterPanel extends React.Component {
  ...
  renderTimePickerPart() {
    let {timePickerProps, filters, onFiltersChange, getPopupContainer, mainTimeDimFilterDeletable, dropdownClassName} = this.props
        ...
        {({isFetching, data, fetch}) => {
          ...
          return (
            <MultiSelect
              ...
              getPopupContainer={getPopupContainer}
              options={topN}
              className="itblock width200 height32 ant-select-selector"
  ...
  renderFilterTile = ({filter, idx, dbDimDict, className}) => {
    ...
    return (
      ...
      >
        ...
        <div className='itblock border ant-select-selector'>
          {
