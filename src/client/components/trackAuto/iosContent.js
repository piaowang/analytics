...
export default class iOSContent {
  ...
  equalColType(id, type) {
    ...
    switch (type) {
      ...
      case CONTROLL_TYPE.WKWebView:
        return classs.includes(type)
          && _.get(this.cachedObjects, `${id}.${CONTROLL_PROP.htmlPage}`, null)
  ...
  getEventInfoByCode(viewHashCode) {
    ...
    editEvent.sugo_autotrack_position = _.get(this.cachedObjects, `${viewHashCode}.sugo_autotrack_position`, '')
    editEvent.sugo_autotrack_content = _.get(this.cachedObjects, `${viewHashCode}.sugo_autotrack_content`, '')
    editEvent.sugo_autotrack_path = _.get(this.cachedObjects, `${viewHashCode}.sugo_autotrack_path`, '')
    editEvent.sugo_autotrack_page_path = _.get(this.cachedObjects, `${viewHashCode}.sugo_autotrack_page_path`, '')
    return editEvent
  }
  ...
  eachHtmlNodes(webView) {
    if (!webView.htmlPage.nodes) return {}
