...
class EchartsBar extends Component {
  ...
  render() {
    let {
      data, dimensions, metrics, translationDict, isThumbnail, showLegend, metricsFormatDict,
      dimensionColumnFormatterGen, dimensionExtraSettingDict, theme='light',...rest
    } = this.props

    if (dimensions.length !== 2) {
      return <Alert msg={'请设置两个维度'} {...rest} />
    }
