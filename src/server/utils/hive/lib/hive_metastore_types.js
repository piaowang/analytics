...
InsertEventRequestData.prototype.write = function(output) {
  ...
  if (this.filesAdded !== null && this.filesAdded !== undefined) {
    ...
    for (var iter565 in this.filesAdded)
    {
      if (this.filesAdded.hasOwnProperty(iter565))
      {
        iter565 = this.filesAdded[iter565]
        output.writeString(iter565)
      }
    }
    output.writeListEnd()
    output.writeFieldEnd()
      ...
      case 5:
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i571 = 0; _i571 < _size566; ++_i571)
          {
            ...
            this.partitionVals.push(elem572)
          }
          input.readListEnd()
        } else {
          input.skip(ftype)
...
FireEventRequest.prototype.write = function(output) {
  ...
  if (this.partitionVals !== null && this.partitionVals !== undefined) {
    ...
    for (var iter573 in this.partitionVals)
    {
      if (this.partitionVals.hasOwnProperty(iter573))
      {
        iter573 = this.partitionVals[iter573]
    ...
    switch (fid)
    {
      case 1:
        if (ftype == Thrift.Type.MAP) {
          ...
          var _ktype575 = 0
          var _vtype576 = 0
          _rtmp3578 = input.readMapBegin()
          _ktype575 = _rtmp3578.ktype
          _vtype576 = _rtmp3578.vtype
          _size574 = _rtmp3578.size
          for (var _i579 = 0; _i579 < _size574; ++_i579)
          {
            var key580 = null
            var val581 = null
            key580 = input.readI64()
            val581 = new ttypes.MetadataPpdResult()
            val581.read(input)
            this.metadata[key580] = val581
          }
          input.readMapEnd()
        } else {
          input.skip(ftype)
...
GetFileMetadataByExprResult.prototype.write = function(output) {
  ...
  if (this.metadata !== null && this.metadata !== undefined) {
    ...
    for (var kiter582 in this.metadata)
    {
      if (this.metadata.hasOwnProperty(kiter582))
      {
        var viter583 = this.metadata[kiter582]
        output.writeI64(kiter582)
        viter583.write(output)
      }
    }
    output.writeMapEnd()
    output.writeFieldEnd()
    ...
    switch (fid)
    {
      case 1:
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem590 = null
            elem590 = input.readI64()
            this.fileIds.push(elem590)
          }
          input.readListEnd()
        } else {
          input.skip(ftype)
...
GetFileMetadataByExprRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    ...
    for (var iter591 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter591))
      {
        iter591 = this.fileIds[iter591]
        output.writeI64(iter591)
      }
    }
    output.writeListEnd()
    output.writeFieldEnd()
      ...
      case 1:
        if (ftype == Thrift.Type.MAP) {
          ...
          for (var _i597 = 0; _i597 < _size592; ++_i597)
          {
            var key598 = null
            var val599 = null
            key598 = input.readI64()
            val599 = input.readBinary()
            this.metadata[key598] = val599
          }
          input.readMapEnd()
        } else {
          input.skip(ftype)
...
GetFileMetadataResult.prototype.write = function(output) {
  ...
  if (this.metadata !== null && this.metadata !== undefined) {
    ...
    for (var kiter600 in this.metadata)
    {
      if (this.metadata.hasOwnProperty(kiter600))
      {
        var viter601 = this.metadata[kiter600]
        output.writeI64(kiter600)
        output.writeBinary(viter601)
      }
    }
    output.writeMapEnd()
    output.writeFieldEnd()
    ...
    switch (fid)
    {
      case 1:
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem608 = null
            elem608 = input.readI64()
            this.fileIds.push(elem608)
          }
          input.readListEnd()
        } else {
          input.skip(ftype)
...
GetFileMetadataRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    output.writeFieldBegin('fileIds', Thrift.Type.LIST, 1)
    output.writeListBegin(Thrift.Type.I64, this.fileIds.length)
    for (var iter609 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter609))
      {
        iter609 = this.fileIds[iter609]
        output.writeI64(iter609)
      }
    }
    output.writeListEnd()
    output.writeFieldEnd()
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == Thrift.Type.LIST) {
          ...
          this.metadata = []
          var _etype620 = 0
          _rtmp3621 = input.readListBegin()
          _etype620 = _rtmp3621.etype
          _size617 = _rtmp3621.size
          for (var _i622 = 0; _i622 < _size617; ++_i622)
          {
            var elem623 = null
            elem623 = input.readBinary()
            this.metadata.push(elem623)
          }
          input.readListEnd()
        } else {
          input.skip(ftype)
...
PutFileMetadataRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    output.writeFieldBegin('fileIds', Thrift.Type.LIST, 1)
    output.writeListBegin(Thrift.Type.I64, this.fileIds.length)
    for (var iter624 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter624))
      {
        iter624 = this.fileIds[iter624]
        output.writeI64(iter624)
      }
    }
    output.writeListEnd()
    output.writeFieldEnd()
  ...
  if (this.metadata !== null && this.metadata !== undefined) {
    ...
    for (var iter625 in this.metadata)
    {
      if (this.metadata.hasOwnProperty(iter625))
      {
        iter625 = this.metadata[iter625]
        output.writeBinary(iter625)
      }
    }
    output.writeListEnd()
    output.writeFieldEnd()
    ...
    switch (fid)
    {
      case 1:
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem632 = null
            elem632 = input.readI64()
            this.fileIds.push(elem632)
          }
          input.readListEnd()
        } else {
          input.skip(ftype)
...
ClearFileMetadataRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    output.writeFieldBegin('fileIds', Thrift.Type.LIST, 1)
    output.writeListBegin(Thrift.Type.I64, this.fileIds.length)
    for (var iter633 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter633))
      {
        iter633 = this.fileIds[iter633]
        output.writeI64(iter633)
      }
    }
    output.writeListEnd()
    output.writeFieldEnd()
    ...
    switch (fid)
    {
      case 1:
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem640 = null
            elem640 = new ttypes.Function()
            elem640.read(input)
            this.functions.push(elem640)
          }
          input.readListEnd()
        } else {
          input.skip(ftype)
...
GetAllFunctionsResponse.prototype.write = function(output) {
  ...
  if (this.functions !== null && this.functions !== undefined) {
    ...
    for (var iter641 in this.functions)
    {
      if (this.functions.hasOwnProperty(iter641))
      {
        iter641 = this.functions[iter641]
