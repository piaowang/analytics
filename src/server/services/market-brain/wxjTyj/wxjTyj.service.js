...
import { SENDCHANNELENUM, WXJTYJCHANNELENUM } from 'common/marketBrain/constants'
...
export default class WxjTyjService  {
  constructor() {
  ...
  async preciseJpushPropelling({ event, userList, userGroup }) {
    ...
    if (SENDCHANNELENUM['wxjTyj'][touch_up_way][send_channel] !== WXJTYJCHANNELENUM['jPush'] || !usergroup_id) return
